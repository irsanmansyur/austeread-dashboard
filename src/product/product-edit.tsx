...
import { InputCustom, InputError, EditorText, SelectCustom } from "@/components/form";
...
export default function ProductEdit({ product }: Props) {
  ...
  const { errors, get, data, setData } = useForm<AppInterface.Article>(product);
  ...
  return (
    <HelmetLayout title="Edit Product" breads={[{ text: "Product", url: routes.product.list }, { text: "Edit" }]}>
      <div className="py-8">
        <div className="flex justify-between">
          <h2 className="text-2xl font-semibold leading-tight">Edit Product</h2>
        </div>
