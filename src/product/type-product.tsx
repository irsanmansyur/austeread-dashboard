...
export const TypeProduct = ({ onChange, value, ...props }: Props) => {
  ...
  return (
    <div className="space-y-3">
      <div className="font-bold">Type Product</div>
      <div className="flex justify-start">
        ...
        <div className="mb-[0.125rem] inline-block min-h-[1.5rem] pl-[1.5rem]">
          ...
          />
          <label className="mt-px inline-block pl-[0.15rem] " htmlFor="inlineRadio3">
            Ticket
          </label>
        </div>
      </div>
